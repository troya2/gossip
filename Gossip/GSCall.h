...
typedef NS_ENUM(NSInteger, GSCallMediaState) {
    GSCallMediaStateNone,
    GSCallMediaStateActive,
    GSCallMediaStateLocalHold,
    GSCallMediaStateRemoteHold,
    GSCallMediaStateError
};
...
@property (nonatomic, readonly) GSCallMediaState mediaState; ///< Media state.  Supports KVO notification.
